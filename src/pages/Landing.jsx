...
function Landing() {
          ...
          <div className="nav_section">
            <nav>
              ...
              <ul className="menu">
                ...
                <li className="icons"><a href="#" className="dribble"><span className="fa fa-dribbble" /></a></li>
              </ul>
            </nav>
          </div>
        </div>
      ...
      <div className="feature-grids row text-center">
        <div className="col-lg-3 gd-bottom one">
          <div className="bottom-gd">
            ...
            <p> MAT involves the use of medications, such as methadone, buprenorphine, or naltrexone, in combination with counseling and behavioral therapies. These medications help manage withdrawal symptoms, reduce cravings, and normalize brain chemistry, making it easier for individuals to recover from addiction .</p>
          </div>
        </div>
        <div className="col-lg-3 gd-bottom">
          <div className="bottom-gd">
            ...
            <h3 className="mb-2">
              Cognitive-Behavioral Therapy (CBT): </h3>
            <p>CBT is a widely used therapy for drug addiction. It focuses on identifying and changing negative thought patterns and behaviors associated with drug use. CBT helps individuals develop coping skills, manage triggers, and build a strong support system..</p>
          </div>
        </div>
        <div className="col-lg-3 gd-bottom">
          <div className="bottom-gd">
            ...
            <p> MI is a counseling technique that helps individuals find motivation to change their addictive behaviors. It involves open-ended questions, active listening, and empathy to enhance an individual's motivation and commitment to recovery.</p>
          </div>
        </div>
        <div className="col-lg-3 gd-bottom">
          <div className="bottom-gd">
            ...
            <p>Many treatment centers now offer online appointment booking systems, allowing individuals to conveniently schedule a visit for drug addiction treatment.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="container py-md-5">
      <div className="row banner-grids mb-lg-5">
        ...
        <div className="col-lg-4 content-right">
          ...
          <h4>We will help to find health, to everyone.</h4>
          <p className="mt-2 text-left">Overcoming drug addiction can significantly improve your physical and mental health. It allows you to regain control over your life, reduce the risk of health complications, and increase your overall well-being.</p>
          <ul className="tic-info list-unstyled">
            <li>
              <span className="fa fa-hand-o-right" /> Rebuilding Relationships
            </li>
            <li>
              <span className="fa fa-hand-o-right" /> Personal Growth and Self-Esteem
            </li>
            <li>
              <span className="fa fa-hand-o-right" /> Role Model for Others
            </li>
          </ul>
        </div>
      </div>
      <div className="row mt-lg-5 mt-4 pt-5 text-center" id="stats">
        ...
        <div className="col-lg-4 counter two editContent mt-3">
          ...
          <div className="counter-info">
            <h4>150+</h4>
            <p>Professional medical specialist for counseling at BREADS</p>
          </div>
        </div>
        <div className="col-lg-4 counter editContent mt-3">
          ...
          <div className="counter-info">
            <h4>15+</h4>
            <p>Years of impeccable and successful work by our organization BREADS</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section className="tabs-blue py-5">
    <div className="container pt-md-5">
      ...
      <div className="tab-main mx-auto">
        <input id="tab1" type="radio" name="tabs" className="w3layouts-sm" defaultChecked />
        <label htmlFor="tab1">Drug </label>
        <input id="tab2" type="radio" className="w3layouts-sm" name="tabs" />
        <label htmlFor="tab2">Gadget </label>
        <input id="tab3" type="radio" className="w3layouts-sm" name="tabs" />
      ...
      <div className="row part-grids text-center inner-sec-w3ls d-flex justify-content-center">
        <div className="col-md-6 partgrid2">
          <div className="thumbnail card">
            <div className="img-event">
              <img className="img-fluid" src="images/g1.jpeg" alt="" style={{ margin: 'auto' }} />
            </div>
            <div className="caption card-body p-md-4">
              <h4 className="mb-4 editContent">Natural Drugs</h4>
              <p>
                Natural drugs are derived from substances found in nature, such as plants. These drugs have been used for centuries for various purposes, including medicinal, recreational, or spiritual use. Examples of natural drugs include marijuana, opium, psilocybin mushrooms, and cocaine derived from the coca plant.
              </p>
            </div>
          </div>
        </div>
        <div className="col-md-6 partgrid1">
          <div className="thumbnail card">
            <div className="img-event">
              <img className="img-fluid" src="images/g2.jpeg" alt="" style={{ margin: 'auto' }} />
            </div>
            <div className="caption card-body p-md-4">
              <h4 className="mb-4 editContent">Synthetic Drug</h4>
              <p>
                Synthetic drugs are artificially created in laboratories and are designed to mimic the effects of natural substances or create entirely new effects. These drugs are often produced through chemical processes using various compounds. Synthetic drugs include substances like MDMA (ecstasy), methamphetamine, synthetic cannabinoids, and synthetic opioids.
              </p>
            </div>
          </div>
        </div>
    ...
    <section id="content2" className="inner-w3layouts-wrap">
      <div className="row part-grids text-center">
        <div className="col-md-6 partgrid2 d-flex justify-content-center">
          <div className="thumbnail card">
            <div className="img-event">
              <img className="img-fluid" src="images/g3.jpeg" alt="" style={{ margin: 'auto' }} />
            </div>
            <div className="caption card-body p-md-4">
              <h4 className="mb-4 editContent">Social Media</h4>
              <p>
                Social media addiction is a pervasive issue characterized by excessive use and dependency on social media platforms, often resulting in decreased productivity, isolation, and negative impacts on mental health.
              </p>
            </div>
          </div>
        </div>
        <div className="col-md-6 partgrid1 d-flex justify-content-center">
          <div className="thumbnail card">
            <div className="img-event">
              <img className="img-fluid" src="images/g10.jpeg" alt="" style={{ margin: 'auto' }} />
            </div>
            <div className="caption card-body p-md-4">
              <h4 className="mb-4 editContent">Technology Dependency</h4>
              <p>
                Technology Dependency refers to the excessive reliance and attachment to electronic devices beyond social media platforms, such as smartphones, laptops, tablets, and gaming consoles. It involves compulsive use and difficulty in controlling the time spent on these devices.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="row part-grids text-center">
        <div className="col-md-12 partgrid d-flex justify-content-center">
          <div className="thumbnail card">
            <div className="img-event">
              <img className="img-fluid" src="images/p.jpeg" alt="" style={{ margin: 'auto' }} />
            </div>
            <div className="caption card-body p-md-4">
              <h4 className="mb-4 editContent">Porn</h4>
              <p>
                Porn addiction is a complex issue that affects individuals globally. It involves compulsive and excessive consumption of pornography, leading to negative consequences. It can impair relationships, mental health, and overall well-being. Seeking professional help, support from loved ones, and developing healthy coping mechanisms are essential for overcoming porn addiction.
              </p>
            </div>
          </div>
        </div>
    ...
    <div className="container py-md-5">
      <div className="row banner-grids mb-lg-5">
        <div className="col-lg-6 content-right pt-md-4">
          ...
          <p className="mt-2 text-left">We prioritize the privacy and confidentiality of our visitors. Any personal information collected on our website is handled securely and in compliance with relevant data protection laws. Our privacy policy statement ensures transparency in how we handle data. </p>
          <ul className="tic-info list-unstyled">
            <li>
              <span className="fa fa-hand-o-right" /> strict confidentiality policy in place to protect your privacy
            </li>
            <li>
              <span className="fa fa-hand-o-right" /> We respect your right to remain anonymous or use a pseudonym     when               interacting with our website
            </li>
            <li>
              <span className="fa fa-hand-o-right" /> We are transparent about our privacy practices 
            </li>
          </ul>
        </div>
    ...
    <div className="container py-lg-3">
      ...
      <div className="test-content">
        <div className="testimonials_grid">
          ...
          <p className="sub-test editContent">great website
          </p>
          ...
          <div className="row mt-lg-4 bottom-w3layouts-sec-nav mx-0">
            ...
            <div className="col-md-4 footer-grid_section_w3layouts">
              ...
              <div className="agileinfo_social_icons">
                <h3 className="footer-title mb-lg-4 mb-3">Customer Service</h3>
                <ul className="list-unstyled w3layouts-icons">
                  <li>
                    <a href="about.html">About Us</a>
                  </li>
  ...
  <div className="cpy-right py-3">
    <div className="container">
      <div className="row">
        <p className="col-md-10 text-left">© 2023 Refrain Addiction. All rights reserved </p>
        {/* move top icon */}
        <a href="#home" className="move-top text-lg-right text-center col-md-2"><span className="fa fa-angle-double-up" aria-hidden="true" /></a>
        {/* //move top icon */}
      </div>
    </div>
  </div>
